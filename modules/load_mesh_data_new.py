...
def load_mesh(path, abg = [50, 15, -90], get3d = True, usepickle = True):
    ...
    if usepickle and (os.path.isfile(pickle_file)):
        ...
        print('The *usepickle = True*, but the pickle file (*pickle_mesh*) does not exist.')
...
class fesom_mesh(object):
    ...
    to be able to read also netCDF version (prpbably UGRID convention).
    ...
    def read2d(self):
        ...
        self.nodes=file_content.flag.values
        ...
        self.reso=np.sqrt(self.voltri*np.sqrt(3))/1000.
        """
    ...
    def read3d(self):
        ...
        self.x3 = df.x.values
        self.y3 = df.y.values
        self.x3, self.y3 = scalar_r2g(self.alpha,self.beta,self.gamma,self.x3, self.y3)
